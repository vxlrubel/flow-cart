...
<template>
  <form class="space-y-5" @submit.prevent="emit('submit')">
    <div class="grid gap-5 md:grid-cols-2">
      ...
      >
        ...
        <textarea
          ...
          rows="5"
          class="w-full rounded border border-slate-300 px-4 py-2 text-sm outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
    ...
    <div class="flex items-center justify-end gap-3 border-t border-slate-200 pt-5">
      <button
        type="submit"
        class="rounded bg-sky-500 px-4 h-9 inline-flex items-center justify-center text-sm font-semibold text-white transition hover:bg-sky-600 disabled:cursor-not-allowed disabled:opacity-60 cursor-pointer"
        :disabled="submitting"
      >
